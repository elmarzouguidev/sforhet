...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['failed_jobs', 'jobs', 'password_reset_tokens', 'migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'personal_access_tokens', 'settings', 'taggables', 'translations', 'user_roles'],
        ],
